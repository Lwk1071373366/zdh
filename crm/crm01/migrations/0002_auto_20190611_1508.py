# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2019-06-11 07:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campuses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm01.Campuses', verbose_name='校区')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_list', models.ManyToManyField(to='crm01.ClassList', verbose_name='已报班级')),
                ...
                ('introduce_from', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm01.Customer', verbose_name='转介绍自学员')),
            ],
        ),
