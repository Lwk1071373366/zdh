...
# from django.contrib.auth.models import AbstractUser #用继承的方式创建 用户表 先引入
# # Create your models here.
#
# class UserInfo(AbstractUser):
#
#     telephone = models.CharField(max_length=32,null=True)  #项目中 电话号码设成字符串形式 便于后期查找：filter(telephone_startswith = '159')
